...
parser.add_argument('--E2C', metavar='DIR',
                    help='path to E2C.json', default='/data2/data_B/preprocessed/E2C.json')
parser.add_argument('--C2E', metavar='DIR',
                    help='path to C2E.json', default='/data2/data_B/preprocessed/C2E.json')
...
parser.add_argument('--save-path', metavar='DIR',
                    help='path to save transcription result', default='/data2/data_B/5-fold/1/result/beam')
